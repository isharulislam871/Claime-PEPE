...
import { closeBannedUserPopup, selectIsBannedUserPopupVisible, openSupportPopup } from '@/modules';
...
export default function BannedUserPopup({ user }: BannedUserPopupProps) {
