...
import { closeSuspendedUserPopup, selectIsSuspendedUserPopupVisible, openSupportPopup } from '@/modules';
import { AppDispatch } from '@/modules/store';

interface SuspendedUserPopupProps {
  user: {
    id?: string;
    banReason?: string;
  };
...
export default function SuspendedUserPopup({ user }: SuspendedUserPopupProps) {
